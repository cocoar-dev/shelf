...
hero:
  name: Shelf
  text: Static Documentation Hosting
  tagline: Shelf your Docs. Multi-product, multi-version documentation hosting for Cocoar.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/cocoar-dev/shelf
